        ...
        <div class="row row1">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <button type="button" class="btn btn-success" style="margin-left: 3% ;margin-top: 2%" onclick="getAddReport()">上传文件</button>
                    <!-- /.panel-heading -->
...
<script>
    ...
    function initFileInput(ctrlName) {
        ...
        control.fileinput({
            language: 'zh', //设置语言
            //上传的地址
            uploadUrl: "${pageContext.request.contextPath}/file/insertCompanyFile?fileType=3&companyID=" + companyID,
