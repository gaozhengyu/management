            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <button class="btn btn-success" style="margin-bottom: 1%" data-toggle="modal"
                                data-target="#importPanel">导入
                        </button>
                        <button class="btn btn-success" style="margin-bottom: 1%" data-toggle="modal"
                                data-target="#addPanel">添加公司
                        </button>
            ...
            success: function (data) {
                if (data.success == false) {
                    ...
                    $.ajax({
                        async: false,
                        type: "post",
                        url: "${pageContext.request.contextPath}/admin/saveCompany",
