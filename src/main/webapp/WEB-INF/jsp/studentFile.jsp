            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <button type="button" class="btn btn-success" style="margin-bottom: 2%" onclick="getAddReport()">上传文件</button>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <select id="fileType" class="form-control">
                                ...
                                <option value="3">去向申请表以及审批表</option>
                            </select>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function initFileInput(ctrlName) {
        ...
        control.fileinput({
            language: 'zh', //设置语言
            //上传的地址
            uploadUrl: "${pageContext.request.contextPath}/file/insertStudentFile?studentID="+studentID,
...
//            responsive: true,
    ...
    function deleteFile(studentFileID) {
        $.post(
            "${pageContext.request.contextPath}/file/deleteFile?type=student",
