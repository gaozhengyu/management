                    ...
                    <div class="panel-body panel2">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>教师成绩</label>
                                    <input class="form-control" id="teacherResult" readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label>公司成绩</label>
                                    <input class="form-control" type="number" id="companyResult">
                                </div>
                                <div class="form-group">
                                    <label>最终成绩</label>
...
<script>
    $(function () {
        ...
        $("#companyResult").bind('input propertychange',function () {
