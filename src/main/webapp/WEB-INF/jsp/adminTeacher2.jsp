        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="excelImport" name="form1"
                      action="${pageContext.request.contextPath}/excelWork/excelImport?type=teacher"
                ...
                <a href="${pageContext.request.contextPath}/excelWork/downloadMuban?type=teacher">下载模板</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">添加指导教师</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="saveTeacher()">保存</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
